    ...
    <div class="container-fluid" style="padding:0;">
        <div class="row" style="--bs-gutter-x: 0.75rem; margin: 0;">
            ...
            <div class="col-md-9 offset-md-3 col-12 main-app-content">
                <?php include "components/main_app_content/category/category_component.php"?>
            </div>
        </div>
    </div>
    <?php include "components/main_app_content/category/create_category_modal.php"?>
    <?php include "components/main_app_content/category/update_category_modal.php"?>
    
    <script src="backend/javascript/main_app_content/category.js"></script>
</body>
</html>